  ...
  return (
    <div className="login">
      <div className="holder">
        <h1 className="text-danger pranjal">{page ? 'Sign In' : 'Register'}</h1>
        <br />
        <form>
          <input
            ...
            placeholder="Email"
          />
       { !emailValid && <p className="text-red-700">Email Is Invalid/Blank</p>}
          <input
            className="form-control"
            type="password"
            value={password}
          ...
          />
          { !passwordValid && <p className="text-red-700">Password Is Invalid/Blank</p>}
          <button
            className="btn btn-danger btn-block text-sm/[17px]"
        ...
        <br />
        <br />
         {isUserExist && <p className="text-danger">User Does't Not Exist || Go For SignUp</p>}
         {isEmailUsed && <p className="text-danger">Email Already In Use || Go For Sign In</p>}
        <div className="login-form-other">
          <div className="login-signup-now">
          {page ? 'New To Reactflix ? ' : 'Existing User'}
